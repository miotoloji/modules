...
use Miotoloji\Modules\Exceptions\InvalidAssetPath;
use Miotoloji\Modules\Exceptions\ModuleNotFoundException;
use Miotoloji\Modules\Process\Installer;
use Miotoloji\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @param string $args
     * @param string $path
     * @return \Miotoloji\Modules\Module
     */
     ...
     * @return string
     * @throws \Miotoloji\Modules\Exceptions\ModuleNotFoundException
     */
